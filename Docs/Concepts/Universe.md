A Universe organizes and contains references to all [[Concepts/Enumeration|Enumerations]], [[Archetype]]s, [[Model]]s, and [[Component]]s registered by a [[Loader]] in [[XBam]].
